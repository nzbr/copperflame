...
\newfontfamily{\fixedsys}{Fixedsys Excelsior 3.01}[ %NONIX
    %NIX \newfontfamily{\fixedsys}{fixedsys-excelsior-3.00}[
    %NIX Path = @fixedsysExcelsior@/share/fonts/truetype/,
    %NIX Extension = .ttf,
    NFSSFamily=fixedsys,
    Scale=1.25
]
...
$else$
\setbeamerfont{frametitle}{family=\fixedsys}
$endif$
% ===== END FONTS =====
...
\newtcolorbox{FrameTitle}{
    ...
    top = 4pt, bottom = 4pt,
    %NIX interior style={fill tile image=@out@/assets/acrylic-texture.png},
    drop fuzzy shadow south=shadow % TODO: shadow is too long
}
